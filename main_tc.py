...
if __name__== "__main__":
    ...
    print('1')
    for tc in range(1, 10, 1):    # ##################100:400users
        tc = tc/10
    ...
    fig1=plt.figure(1)
    plt.plot(list_tc, list_random, color='green', label='random')
    plt.plot(list_tc, list_nearest, color='red', label='nearest')
    plt.plot(list_tc, list_smallest, color='blue', label='smallest')
    plt.plot(list_tc, list_furthest, color='black', label='furthest')
    plt.plot(list_tc, list_furthest_p, color='yellow', label='furthest_p')
    plt.legend()
    ...
    fig2=plt.figure(2)
    plt.plot(list_tc, list_random_total_size, color='green', label='random')
    plt.plot(list_tc, list_nearest_total_size, color='red', label='nearest')
    plt.plot(list_tc, list_smallest_total_size, color='blue', label='smallest')
    plt.plot(list_tc, list_furthest_total_size, color='black', label='furthest')
    plt.plot(list_tc, list_furthest_p_total_size, color='yellow', label='furthest_p')
    plt.legend()
    ...
    fig3 = plt.figure(3)
    plt.plot(list_tc, list_random_success_select_bit, color='green', label='random')
    plt.plot(list_tc, list_nearest_success_select_bit, color='red', label='nearest')
    plt.plot(list_tc, list_smallest_success_select_bit, color='blue', label='smallest')
    plt.plot(list_tc, list_furthest_success_select_bit, color='black', label='furthest')
    plt.plot(list_tc, list_furthest_p_success_select_bit, color='yellow', label='furthest_p')
    ...
    fig4 = plt.figure(4)
    plt.plot(list_tc, list_random_success_total_bit, color='green', label='random')
    plt.plot(list_tc, list_nearest_success_total_bit, color='red', label='nearest')
    plt.plot(list_tc, list_smallest_success_total_bit, color='blue', label='smallest')
    plt.plot(list_tc, list_furthest_success_total_bit, color='black', label='furthest')
    plt.plot(list_tc, list_furthest_p_success_total_bit, color='yellow', label='furthest_p')
    plt.legend()
